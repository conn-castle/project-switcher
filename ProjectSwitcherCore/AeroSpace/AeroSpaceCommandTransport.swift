...
/// orchestration (recovery, retry) lives in `PsAeroSpace`.
struct AeroSpaceCommandTransport {
    private static let logger = Logger(subsystem: "com.projectswitcher", category: "AeroSpaceCommandTransport")
    ...
    func breakerOpenError(detailOverride: String? = nil) -> PsCoreError {
