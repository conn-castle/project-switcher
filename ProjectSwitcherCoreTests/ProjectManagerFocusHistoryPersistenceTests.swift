...
final class ProjectManagerFocusHistoryPersistenceTests: XCTestCase {
    func testFocusHistoryPersistsAcrossManagers() async {
        ...
        let window = PsWindow(windowId: 42, appBundleId: "com.apple.Terminal", workspace: "main", windowTitle: "Terminal")
        ...
        aero2.focusedWindowResult = .failure(PsCoreError(message: "no focus"))
